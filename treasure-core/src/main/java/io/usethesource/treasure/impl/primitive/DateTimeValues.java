...
import io.usethesource.treasure.exceptions.InvalidDateTimeException;
...
/*package*/ class DateTimeValues {
	...
	private static class DateValue extends AbstractValue implements IDateTime {
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getInstant()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getCentury()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getYear()
		 */
		@Override
		public int getYear() {
			return this.year;
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getMonthOfYear()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getDayOfMonth()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getHourOfDay()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getMinuteOfHour()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getSecondOfMinute()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getMillisecondsOfSecond()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getTimezoneOffsetHours()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#getTimezoneOffsetMinutes()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#isDate()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#isTime()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see io.usethesource.treasure.IDateTime#isDateTime()
		 */
		@Override
