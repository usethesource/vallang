...
public final class ListSmokeTest {
  ...
  public ListSmokeTest(final IValueFactory vf) {
    this.vf = vf;
  }
  ...
  public void testIsSubListOf() {
    ...
    IList L918273 =
        vf.list(integers[9], integers[1], integers[8], integers[2], integers[7], integers[3]);
    IList L918372 =
        vf.list(integers[9], integers[1], integers[8], integers[3], integers[7], integers[2]);
  ...
  public void testSubtract() {
    ...
    IList L321321 =
        vf.list(integers[3], integers[2], integers[1], integers[3], integers[2], integers[1]);
